...
| **E9** Toolpath Annotations & Renderer Options (#162) | **In progress** | [DD-009](design/DD-009-toolpath-annotations-and-renderer-options.md) **Accepted** (D1–D7); post-`v0.1.0` feature set. **Phase 1 shipped:** retraction/deretraction markers (#148, D1 amended — added an additive `retractions` IR channel). Next: ortho camera (#150), M600 color-change (#147), theming (#153), Custom Element adapter (#149), multi-gcode workaround (#151) |
