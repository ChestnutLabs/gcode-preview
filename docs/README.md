...
| **E6** Vue Package & AnyBridge Consumer Integration (#7) | **In Progress** — at the DD gate | [DD-007](design/DD-007-vue-integration-and-anybridge-consumer-boundary.md) **Proposed** (issue #101) grounded in the AnyBridge frontend evidence (Vue 3.4/3.5 + Vite 5); awaiting maintainer decisions — no implementation before acceptance |
