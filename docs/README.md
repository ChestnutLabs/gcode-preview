...
| **E6** Vue Package & AnyBridge Consumer Integration (#7) | **In Progress** — implementation phase | [DD-007](design/DD-007-vue-integration-and-anybridge-consumer-boundary.md) **Accepted** (2026-07-23, D1–D4 with clarifications; **D1 amended: first-class Vue/React/Svelte adapters over a shared engine**, Vue = reference); phased issues open (8 phases); D3 addition: E7 gains the repository-publication pass covering all three frameworks |
