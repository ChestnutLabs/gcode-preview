...
`v0.10.0`** (lockstep, npm provenance); `main` is the release branch, publishing from tagged GitHub
...
tube-mesh memory budget + object-framing fix RR-006). Changesets accumulate on `dev` for the next release.
