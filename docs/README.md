...
| **E7** Release, Documentation & Ecosystem (#8) | Open, gated — **next** | DD-008 unwritten; committed scope: #109 repository-publication pass (all three frameworks), #118 chrome decision, coverage-guided fuzzing (from E4 §7.3), versioning/changelog, reference-machine measurement list |
| E8 | Open, gated | Future/deferred |
