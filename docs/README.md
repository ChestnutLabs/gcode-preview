...
| **E9** Toolpath Annotations & Renderer Options (#162) | Open, gated | [DD-009](design/DD-009-toolpath-annotations-and-renderer-options.md) **Accepted** (D1–D7); post-`v0.1.0` feature set (retraction markers, ortho camera, M600 color-change, theming, Custom Element adapter, multi-gcode workaround) |
