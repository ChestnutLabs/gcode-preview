...
| **E6** Vue Package & AnyBridge Consumer Integration (#7) | **Implementation complete** — at the epic acceptance gate | [DD-007](design/DD-007-vue-integration-and-anybridge-consumer-boundary.md) **Accepted** (D1 amended: Vue/React/Svelte over shared `gcode-preview-core`); all 8 phases merged (#104–#108, #112–#114); shared behavioral suite green in all three adapters; consumer tarball fixture in CI; [evidence + parity table](../tools/benchmark/results/e6-multiframework-evidence-2026-07-23.md); E7's #109 publication pass covers all three frameworks |
| E7–E8 | Open, gated | DD-008 unwritten — no implementation before each gate |
