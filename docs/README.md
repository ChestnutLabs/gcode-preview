...
| **E5** Live Progress Mapping (#6) | **In Progress** — implementation phase | [DD-006](design/DD-006-normalized-live-progress-and-source-position-mapping.md) **Accepted** (2026-07-23, D1–D5 as proposed, D3 clarified; issue #87) with real AnyBridge telemetry evidence recorded in §1.1; phased issues open |
