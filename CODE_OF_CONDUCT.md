...
maintainers privately. For this repository, use **GitHub Private Vulnerability Reporting** or another
private channel described in [`SECURITY.md`](SECURITY.md); do not report conduct concerns in public
...
1. **Correction** — Community Impact: use of inappropriate language or other behavior deemed
   unprofessional or unwelcome. Consequence: a private, written warning, with clarity around the nature
